...
class CitizenTicketHistoryItem(BaseModel):
    ...
    can_submit_resolution_feedback: bool = Field(
        default=False, alias="canSubmitResolutionFeedback"
    )
    resolution_feedback_status: str | None = Field(
        default=None, alias="resolutionFeedbackStatus"
    )
